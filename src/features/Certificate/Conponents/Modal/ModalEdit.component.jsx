import { Form, Image, Input, Modal, Spin } from 'antd';
...
const ModalEditCertificteConponent = (props) => {
  const { visibleEdit, handleCancel, onFinish, certificate, imgeUrl, setImageUrl, loading } = props;
      ...
      <Modal
        ...
        <Spin tip='Đang tải dữ liệu...' spinning={loading}>
          <Form name='edit' id='edit-form' onFinish={onFinish} fields={field}>
            ...
            <Image
              width={100}
              src={certificate?.thumbnailUrl !== null ? certificate?.thumbnailUrl : 'error'}
